...
export function Footer() {
  return (
    <footer className="w-full liquid-glass-footer py-8 px-6 border-t border-white/10 mt-auto">
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
        ...
        {/* Center: Legal Links */}
        <div className="flex items-center gap-6 text-xs uppercase tracking-wider font-mono text-slate-400">
          <Link
            href="/privacy"
